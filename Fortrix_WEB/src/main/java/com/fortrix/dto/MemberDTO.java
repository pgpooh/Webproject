...
public class MemberDTO {
	...
	public MemberDTO(int mb_index_no, String mb_id, String mb_name, String mb_flag, String mb_brith, String mb_pw,String mb_email,String mb_phone) {
	...
	public String toString() {
		return "MemberDTO [mb_index_no=" + mb_index_no  + ", mb_id=" + mb_id + ", mb_name=" + mb_name + ", mb_flag=" + mb_flag + ", mb_brith=" + mb_brith + ", mb_pw=" + mb_pw + ", mb_email=" + mb_email + ", mb_phone=" + mb_phone  + "]";
	}
